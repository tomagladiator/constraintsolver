...
const REGENERATE_METHOD = _require.REGENERATE_METHOD;
    ...
    visitor: {
      ...
      Class(classPath) {
        ...
        if (hasMethods && !hasRegenerateMethod) {
          const regenerateMethod = t.classMethod('method', t.identifier(REGENERATE_METHOD), [t.identifier('key'), t.identifier('code')], t.blockStatement([evalTemplate()]));

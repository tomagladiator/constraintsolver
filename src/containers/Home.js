    ...
    <div className="content">
      <div className="columns   is-flex-align-center">
        <div className="column   is-narrow">
          <figure className="image is-128x128 is-object-fit-cover is-round">
            <img
              ...
              src={`${personContent.includes.Asset[0].fields.file.url}?h=128&w=128&fit=fill`}
              alt={personContent.items[0].fields.name}
            />
          </figure>
        </div>
        ...
        <div className="column">
          ...
          <p>
            <strong>Poste actuel</strong> : {personContent.items[0].fields.company}
            <br />
